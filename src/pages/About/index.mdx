...
<img
  src={require('/img/12786.jpg').default}
  alt="Example banner"
  width="30%"
/>
...
### <Highlight color="#33e7ff">My Profile Summary</Highlight>
...
### <Highlight color="#33e7ff">Technical Skills</Highlight>
...
### <Highlight color="#33e7ff">Work Experience</Highlight>

##### <Highlight color="#33e7ff">1)Larsen and Toubro Infotech , Pune   ( 24/07/2018 – 12/03/2021)</Highlight>
- **Role** : Quality Engineer
- **Application Domains**: Banking & Finance , Insurance
- **Responsibilities**:
● Creating Test Strategies and Test Plans
● Automated feasible modules in Selenium-Ruby, Selenium-Java using BDD-Cucumber
● Executed automation scripts for regression of existing team stewarded applications and implemented fixes wherever required.
● Automated test cases for Angular JS applications in CodeceptJS
● Web service testing using postman
● Defect logging and tracking in JIRA
● Testware preparation and maintenance
● Managed, tracked and coordinated software testing efforts using TestRail
● Debugging test failures and identifying the root cause

##### <Highlight color="#33e7ff">2)ThoughtWorks , India   ( 12/03/2021 – Present)</Highlight>
- **Role** : Quality Analyst
- **Application Domains**: Banking & Finance
- **Responsibilities**:
● Enhancing and maintaining automation scripts for smoke and regression testing using automation tools like Webdriver and Appium
● Developing and maintaining Test Plans and Test specifications
● API  testing using postman
● Defect logging and tracking in JIRA
● Testware preparation and maintenance
●  Debugging test failures and identifying the root cause

### <Highlight color="#33e7ff"> Education </Highlight>
...
### <Highlight color="#33e7ff"> Papers Presented </Highlight>
...
### <Highlight color="#33e7ff"> Extra-curricular Involvements </Highlight>
	•	Actively participated in co-curricular activities like volunteering for our annual technical festival – ‘ALGORITHM’ organized by ’Association of Students of Computer and IT’ (ASCI), wherein I designed various coding questions for the events and resolved technical issues.
